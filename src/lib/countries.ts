...
export const supportedCountries: SupportedCountry[] = [
  ...
  { code: "MA", name: "Morocco",       flag: "🇲🇦", dial: "+212", currency: "EUR", language: "fr", cities: ["Casablanca", "Rabat", "Marrakesh", "Fez", "Tangier", "Agadir"] },
  { code: "QA", name: "Qatar",         flag: "🇶🇦", dial: "+974", currency: "AED", language: "ar", cities: ["Doha", "Al Wakrah", "Al Khor", "Lusail", "Al Rayyan"] },
  { code: "SA", name: "Saudi Arabia",  flag: "🇸🇦", dial: "+966", currency: "AED", language: "ar", cities: ["Riyadh", "Jeddah", "Mecca", "Medina", "Dammam", "Khobar"] },
  { code: "EG", name: "Egypt",         flag: "🇪🇬", dial: "+20",  currency: "AED", language: "ar", cities: ["Cairo", "Alexandria", "Giza", "Sharm El Sheikh", "Luxor"] },
  { code: "MY", name: "Malaysia",      flag: "🇲🇾", dial: "+60",  currency: "SGD", language: "en", cities: ["Kuala Lumpur", "George Town", "Johor Bahru", "Ipoh", "Shah Alam"] },
  ...
  { code: "PH", name: "Philippines",   flag: "🇵🇭", dial: "+63",  currency: "SGD", language: "en", cities: ["Manila", "Quezon City", "Cebu", "Davao", "Makati"] },
  { code: "KW", name: "Kuwait",        flag: "🇰🇼", dial: "+965", currency: "AED", language: "ar", cities: ["Kuwait City", "Hawalli", "Salmiya", "Jahra"] },
  ...
  { code: "CI", name: "Côte d'Ivoire", flag: "🇨🇮", dial: "+225", currency: "EUR", language: "fr", cities: ["Abidjan", "Yamoussoukro", "Bouaké", "Daloa", "San-Pédro"] },
  ...
  { code: "CH", name: "Switzerland",   flag: "🇨🇭", dial: "+41",  currency: "EUR", language: "fr", cities: ["Zürich", "Geneva", "Basel", "Bern", "Lausanne"] },
];
